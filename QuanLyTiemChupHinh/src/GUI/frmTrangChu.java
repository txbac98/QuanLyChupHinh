...
public class frmTrangChu extends javax.swing.JInternalFrame {
    ...
    public void Show(){
        ...
        lbTongKH.setText(KhachHangBUS.TongSoKH());
        lbSoPCTong.setText(PhieuChupBUS.TongSoPC());
        lbSoPCThang.setText(PhieuChupBUS.TongSoPCTuDauThang());
        lbDoanhThuTong.setText(PhieuThanhToanBUS.TongDoanhThu());
        lbDoanhThuThang.setText(PhieuThanhToanBUS.TongDoanhThuTuDauThang());
    }
