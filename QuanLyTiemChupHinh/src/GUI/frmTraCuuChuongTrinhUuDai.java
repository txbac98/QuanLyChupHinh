 ...
 * @author 16520
 */
public class frmTraCuuChuongTrinhUuDai extends javax.swing.JFrame {

    /**
     * Creates new form frmTraCuuChuongTrinhUuDai
     */
    public frmTraCuuChuongTrinhUuDai() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTraCuuChuongTrinhUuDai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTraCuuChuongTrinhUuDai().setVisible(true);
            }
        });
    }
