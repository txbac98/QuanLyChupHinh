 ...
 * @author 16520
 */
public class frmTraCuuBangHoachToan extends javax.swing.JFrame {

    /**
     * Creates new form frmTraCuuBangHoachToan
     */
    public frmTraCuuBangHoachToan() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTraCuuBangHoachToan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTraCuuBangHoachToan().setVisible(true);
            }
        });
    }
