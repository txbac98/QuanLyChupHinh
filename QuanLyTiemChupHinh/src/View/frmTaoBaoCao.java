 ...
 * @author 16520
 */
public class frmTaoBaoCao extends javax.swing.JFrame {

    /**
     * Creates new form frmXuatBaoCao
     */
    public frmTaoBaoCao() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTaoBaoCao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTaoBaoCao().setVisible(true);
            }
        });
    }
