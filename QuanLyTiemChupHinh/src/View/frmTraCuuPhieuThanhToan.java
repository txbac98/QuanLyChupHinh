 ...
 * @author 16520
 */
public class frmTraCuuPhieuThanhToan extends javax.swing.JFrame {

    /**
     * Creates new form frmTraCuuPhieuThanhToan
     */
    public frmTraCuuPhieuThanhToan() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTraCuuPhieuThanhToan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTraCuuPhieuThanhToan().setVisible(true);
            }
        });
    }
